...
public class FlinkInterpreter extends Interpreter {
  ...
  public void open() throws InterpreterException {
    ...
    this.z = new FlinkZeppelinContext(getInterpreterGroup().getInterpreterHookRegistry(), maxRow);
...
//  BatchTableEnvironment getBatchTableEnviroment() {
//    return this.innerIntp.getBatchTableEnviroment();
//  }

//  StreamTableEnvironment getStreamTableEnviroment() {
//    return this.innerIntp.getStreamTableEnviroment();
//  }
}
